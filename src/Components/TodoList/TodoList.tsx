    ...
    <div className="max-w-md mx-auto my-8 p-6 bg-base-100 dark:bg-neutral-900 border border-neutral-800 rounded-2xl shadow-xl backdrop-blur-sm">
      ...
      <div className="flex items-center gap-2 mb-6">
        <input
          ...
          className="flex-1 px-4 py-2.5 bg-base-100 dark:bg-neutral-900 border border-neutral-800 rounded-xl text-sm focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all text-neutral-100 placeholder:text-neutral-500"
        />
        <button
          onClick={() => handleAddTask()}
          type="button"
          className="px-4 py-2.5 bg-cyan-500 text-text-neutral-900 dark:text-base font-medium rounded-xl text-sm hover:bg-cyan-400 active:scale-95 transition-all flex items-center gap-1.5 shadow-md shadow-cyan-500/20 shrink-0"
        >
      ...
      {/* Items Container Div */}
      <div className="space-y-2 min-h-40 p-2 bg-base-100 dark:bg-neutral-900 border border-neutral-800/60 rounded-xl">
